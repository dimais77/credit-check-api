...
down_revision: Union[str, Sequence[str], None] = '097dac109ea7'
...
def upgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['check_id'], ['checks.id'], name=op.f('fk_idempotency_keys_check_id_checks'), ondelete='CASCADE'),
